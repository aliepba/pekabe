<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Alief Bagaskara Alamsyah</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
        <div class="nav nav-dark">
            ...
            <a href="https://aliepba.github.io/cv/" target="_blank" class="nav-link pl-0 pr-0">Website</a>
        </div>
        <!--end::Nav-->
    </div>
    <!--end::Container-->
