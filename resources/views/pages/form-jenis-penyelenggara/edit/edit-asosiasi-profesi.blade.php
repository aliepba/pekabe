                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="jenis_penyelenggara" id="jenis_penyelenggara" class="form-control selectpicker">
                                        <option value="{{$data->penyelenggara}}">-- {{$data->asosiasiProfesi->Nama_Lengkap}} --</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="Email Instansi" id="nama_instansi" value="{{$data->nama_instansi}}" name="nama_instansi"/>
