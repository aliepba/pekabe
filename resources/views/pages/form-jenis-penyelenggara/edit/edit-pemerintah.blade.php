                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="jenis_penyelenggara" id="jenis_penyelenggara" class="form-control selectpicker">
                                        ...
                                        <option value="NO-PUPR">Kementerian Non PUPR/Lembaga/Instansi Lainnya</option>
                                        <option value="OPD-PROVINSI">OPD Provinsi</option>
                                        <option value="OPD-KAB/KOTA">OPD Kabupaten/Kota</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="Email Instansi" id="nama_instansi" name="jenis" value="1"/>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="No Telepon" name="telepon" value="{{$data->telepon}}" required/>
                                </div>
                                <div class="form-group">
