                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-sm font-weight-bolder text-dark">Institusi Diklat <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="Email Instansi" id="nama_instansi" name="jenis" value="5"/>
                                </div>
                                <div class="form-group">
