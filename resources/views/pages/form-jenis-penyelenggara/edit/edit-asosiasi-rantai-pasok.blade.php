                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="Email Instansi" id="nama_instansi" name="jenis" value="4"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="text-sm font-weight-bolder text-dark">Pengesahan badan hukum perkumpulan dari Kemenkumham <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Alamat" name="alamat" rows="7" required>{{$data->alamat}}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr />
