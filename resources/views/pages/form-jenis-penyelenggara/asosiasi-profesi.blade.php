                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Email Instansi" id="email" name="email_instansi" required/>
                                    <input type="hidden" class="form-control" placeholder="Email Instansi" id="nama_instansi" name="nama_instansi"/>
                                    <input type="hidden" class="form-control" placeholder="Email Instansi" id="nama_instansi" name="jenis" value="2"/>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="No Telepon" id="telepon" name="telepon" required/>
                                </div>
                                <div class="form-group">
...
<script>
    $(document).ready(function(){
        $('#jenis_penyelenggara').change(function(){
            ...
            $.ajax({
                url : "/detail-asosiasi-profesi?id_asosiasi_profesi="+idAsosiasi,
                dataType : 'JSON',
