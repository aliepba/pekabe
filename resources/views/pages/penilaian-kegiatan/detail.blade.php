        ...
        <div class="col-lg-12 col-xxl-12">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body pt-4">
                    ...
                    @foreach ($data->unsurKegiatan as $unsurKegiatan)
                    <div class="row">
                        @foreach (\App\Models\MtBobotPenilaian::where('id', $unsurKegiatan->unsur->id_bobot_penilaian)->get() as $j)
                        <div class="col-md-12">
                                <h5 class="h5">{{$unsurKegiatan->unsur->nama_sub_unsur}}</h5>
                                <div class="form-group row mt-5">
                                    <label  class="col-2 col-form-label">Nilai SKPK</label>
                                    <div class="col-10">
                                        <input class="form-control" type="number" min="0" max="{{$unsurKegiatan->unsur->nilai_skpk}}" name="nilai_skpk[]" required/>
                                        <span class="text-muted">Maks Nilai : {{$unsurKegiatan->unsur->nilai_skpk}}</span>
                                        <input name="id_kegiatan" value="{{$data->uuid}}" hidden/>
                                        <input name="id_unsur[]" value="{{$unsurKegiatan->id_unsur}}" hidden/>
                                    </div>
                                </div>
