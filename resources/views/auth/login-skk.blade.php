...
<div class="login-aside d-flex flex-column flex-row-auto" style="margin-top: -150px;">
    ...
    <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
        ...
        <!--end::Aside header-->
        <!--begin::Aside Title-->
        <h3 class="font-weight-bolder text-center font-size-h4 text-dark-50 line-height-xl">Login dengan Simpan SKK</h3>
        <!--end::Aside Title-->
    </div>
    <!--end::Aside Top-->
    <!--begin::Aside Bottom-->
...
<div class="login-content flex-row-fluid d-flex flex-column p-10" style="margin-top: -150px;">
    ...
    <div class="d-flex flex-row-fluid flex-center">
        ...
        <div class="login-form">
            <!--begin::Form-->
            <form class="form" action="{{route('login.skk')}}" method="POST">
                @csrf
                <!--begin::Form group-->
                ...
                <div class="pb-lg-0 pb-5">
                    ...
                    <a href="{{route('login')}}" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                    <span class="svg-icon svg-icon-md">
                        ...
                        <!--end::Svg Icon-->
                    </span>Sign in with SKK Account</a>
                </div>
                <!--end::Action-->
            </form>
            <!--end::Form-->
